...
if __name__ == '__main__':
    ...
    n_batch = 1
    n_times = 1
    env = mtsp.mtsp(n_cities, n_agent, n_batch, n_times,n_times,2024)
...
###
    ...
    net0 = net.ActNet()
    net0 = net0.to(net.DEVICE)
    net0.load_state_dict(torch.load('/home/ballade/Desktop/Project/MTSP/mywork/save/M-8-date2024-07-14-epoch6-i99-dis_8.37148.pt'))
    x = x.to(net.DEVICE)
    time1 = time.time()
    seq, pro, dis = net0(x, is_train=False)
    time2 = time.time()
    ...
    net2 = net.ActNet()
    net2 = net2.to(net.DEVICE)
    net2.load_state_dict(torch.load('/home/ballade/Desktop/Project/MTSP/mywork/save/date2024-07-12-epoch9-i349-dis_3.48442.pt'))
    x = x.to(net.DEVICE)
    time1 = time.time()
    seq, pro, dis = net2(x, is_train=False)
    time2 = time.time()
    time_net = time2 - time1
    dis_net = torch.mean(dis).cpu().numpy()
    print('time_net:', time_net)
